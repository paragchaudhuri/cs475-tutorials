/*
  CSX75 Tutorial 8 Saving the Framebuffer to a PNG image
...
void initBuffersGL(void)
{
  ...
  std::string vertex_shader_file("08_vshader.glsl");
  std::string fragment_shader_file("08_fshader.glsl");
...
int main(int argc, char** argv)
{
  ...
  window = glfwCreateWindow(512, 512, "CS475/CS675 Tutorial 8: Saving the Framebuffer - Press Z", NULL, NULL);
  if (!window)
    {
      glfwTerminate();
      return -1;
